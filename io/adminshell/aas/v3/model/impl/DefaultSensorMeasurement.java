...
/** 
	* Default implementation of package io.adminshell.aas.v3.model.SensorMeasurement
	 
*/

@IRI("https://w3id.org/i40/rami#SensorMeasurement")
public class DefaultSensorMeasurement implements SensorMeasurement {
	...
	public DefaultSensorMeasurement() {
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DefaultSensorMeasurement other = (DefaultSensorMeasurement) obj;
...
/**
	* This builder class can be used to construct a DefaultSensorMeasurement bean.
*/
	public static class Builder extends SensorMeasurementBuilder<DefaultSensorMeasurement, Builder> {
		...
		@Override
		protected DefaultSensorMeasurement newBuildingInstance() {
			return new DefaultSensorMeasurement();
		}
	}
}
