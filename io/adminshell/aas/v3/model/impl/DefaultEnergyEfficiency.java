...
/** 
	* Default implementation of package io.adminshell.aas.v3.model.EnergyEfficiency
	 
*/

@IRI("https://w3id.org/i40/rami#EnergyEfficiency")
public class DefaultEnergyEfficiency implements EnergyEfficiency {
	...
	protected List<Measure> energyEfficiencyValues = new ArrayList<>();
	...
	public DefaultEnergyEfficiency() {
	}

	@Override
	public int hashCode() {
		return Objects.hash(this.energyEfficiencyValues,
			this.hasViews,
			this.hasValues,
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DefaultEnergyEfficiency other = (DefaultEnergyEfficiency) obj;
			return Objects.equals(this.energyEfficiencyValues, other.energyEfficiencyValues) &&
	...
	@Override 
	public List<Measure> getEnergyEfficiencyValues() {
		return energyEfficiencyValues;
	}
	
	@Override 
	 public void setEnergyEfficiencyValues (List<Measure> energyEfficiencyValues) {
		this.energyEfficiencyValues = energyEfficiencyValues;
	}
...
/**
	* This builder class can be used to construct a DefaultEnergyEfficiency bean.
*/
	public static class Builder extends EnergyEfficiencyBuilder<DefaultEnergyEfficiency, Builder> {
		...
		@Override
		protected DefaultEnergyEfficiency newBuildingInstance() {
			return new DefaultEnergyEfficiency();
		}
	}
}
