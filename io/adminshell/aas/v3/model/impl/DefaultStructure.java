...
/** 
	* Default implementation of package io.adminshell.aas.v3.model.Structure
	 
*/

@IRI("https://w3id.org/i40/rami#Structure")
public class DefaultStructure implements Structure {
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			DefaultStructure other = (DefaultStructure) obj;
...
/**
	* This builder class can be used to construct a DefaultStructure bean.
*/
	public static class Builder extends StructureBuilder<DefaultStructure, Builder> {
		...
		@Override
		protected DefaultStructure newBuildingInstance() {
