...
public abstract class EnergyEfficiencyBuilder<T extends EnergyEfficiency, B extends EnergyEfficiencyBuilder<T, B>> extends ExtendableBuilder<T, B> {

	/**
	* This function allows setting a value for energyEfficiencyValues
	* @param energyEfficiencyValues desired value to be set
	* @return Builder object with new value for energyEfficiencyValues
	*/
	public B energyEfficiencyValues(List<Measure> energyEfficiencyValues) {
		getBuildingInstance().setEnergyEfficiencyValues(energyEfficiencyValues);
		return getSelf();
	}

	/**
	* This function allows adding a value to the List energyEfficiencyValues
	* @param energyEfficiencyValue desired value to be added
	* @return Builder object with new value for energyEfficiencyValues
	*/
	public B energyEfficiencyValue(Measure energyEfficiencyValue) {
		getBuildingInstance().getEnergyEfficiencyValues().add(energyEfficiencyValue);
		return getSelf();
	}
