...
/** 
	* Default implementation of package io.adminshell.aas.v3.model.TransportInterface
	 
*/

@IRI("https://w3id.org/i40/rami#TransportInterface")
public class DefaultTransportInterface implements TransportInterface {
	...
	public DefaultTransportInterface() {
	}
...
/**
	* This builder class can be used to construct a DefaultTransportInterface bean.
*/
	public static class Builder extends TransportInterfaceBuilder<DefaultTransportInterface, Builder> {
		...
		@Override
		protected DefaultTransportInterface newBuildingInstance() {
			return new DefaultTransportInterface();
		}
	}
}
