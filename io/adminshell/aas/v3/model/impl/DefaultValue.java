...
/**
	* This builder class can be used to construct a DefaultValue bean.
*/
	public static class Builder extends ValueBuilder<DefaultValue, Builder> {
		...
		@Override
		protected DefaultValue newBuildingInstance() {
